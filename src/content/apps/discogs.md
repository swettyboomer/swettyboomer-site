...
features:
  - Sync your full Discogs collection and wantlist
  - Browse by artist, label, format, year, or your own shelves
  - Fast local search that works offline
  - See pressing details, tracklists, and cover art at a glance
  - Built for the desktop — keyboard shortcuts and dense, scannable views
icon: /images/icons/discogs.svg
screenshots:
  - /images/screenshots/discogs-1.svg
  - /images/screenshots/discogs-2.svg
  - /images/screenshots/discogs-3.svg
storeLinks:
  microsoft: "#"
privacy:
  dataCollected: []
  thirdParties:
    - Discogs API (only to sync the collection you connect)
status: coming-soon
order: 1
---
